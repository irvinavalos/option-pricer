...
from bspx.types import _F64, DayCount, OptionType


def delta(state: BlackScholesState, option_type: OptionType = "call") -> _F64:
    match option_type:
        case "call":
            return state.cdf_d1
        case "put":
...
def rho(state: BlackScholesState, option_type: OptionType = "call") -> _F64:
